...
const ALL_MICROSERVICES = {
  ...
  'lark-bot': {
    key: 'lark-bot',
    srcPath: 'src/microservices/lark-bot',
    repositoryUrl: 'https://github.com/worldzhy/newbie.lark-bot.git',
    schemaFileName: null,
    settingsFileName: 'lark-bot.settings.json',
    moduleNames: 'LarkBotModule',
    importCode: `import {LarkBotModule} from './lark-bot/lark-bot.module';`,
  },
  'llm-agent': {
    key: 'llm-agent',
    srcPath: 'src/microservices/llm-agent',
    repositoryUrl: 'https://github.com/worldzhy/newbie.llm-agent.git',
    schemaFileName: 'llm-agent.schema',
    settingsFileName: 'llm-agent.settings.json',
    moduleNames: 'LlmAgentModule',
    importCode: `import {LlmAgentModule} from './llm-agent/llm-agent.module';`,
  },
  map: {
    key: 'map',
  ...
  'task-management': {
    key: 'task-management',
    srcPath: 'src/microservices/task-management',
    repositoryUrl: 'https://github.com/worldzhy/newbie.task-management.git',
    schemaFileName: 'task-management.schema',
    settingsFileName: 'task-management.settings.json',
    moduleNames: 'TaskManagementModule',
    importCode: `import {TaskManagementModule} from './task-management/task-management.module';`,
  },
  'tencent-cos': {
    key: 'tencent-cos',

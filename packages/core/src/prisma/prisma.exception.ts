const prismaExceptions = {
  ...
  P1003: 'The requested database does not exist. Please double-check the database name and location.',
  P1008: 'The operation took too long to complete. Please try again later.',
  P1009: 'The specified database already exists on the server. Please choose a different name.',
  P1010: 'Access denied. The user does not have permission to access the requested database.',
  P1011: 'Error opening a secure connection. Please check the TLS configuration and try again.',
  P1012:
    "There's an issue with your schema configuration. Please review the schema definition and fix the reported errors.",
  P1013: 'The provided database string is invalid. Please check the format and details of the string.',
  P1014: 'The underlying kind for the specified model does not exist. Please check the model name and configuration.',
  P1015:
  ...
  P2000: 'The provided value for the column is too long for its data type. Please provide a shorter value.',
  P2001: 'The requested record does not exist in the database.',
  P2002: "A unique constraint failed. The value you're trying to insert conflicts with existing data.",
  P2003: 'A foreign key constraint failed. The specified value does not match any valid foreign key.',
  P2004: 'A constraint failed on the database. Please review the database constraints and data being inserted.',
  P2005: 'The value stored in the database for the specified field is invalid for its data type.',
  P2006: 'The provided value for the specified field of the model is not valid. Please provide a valid value.',
  P2007: 'A data validation error occurred. Please review the data and ensure it adheres to validation rules.',
  P2008: "Failed to parse the query. There's an issue with the provided query syntax.",
  ...
  P2012: 'A required value is missing at the specified path. Please provide the required value.',
  P2013: 'The required argument is missing for the specified field on the specified object.',
  P2014: 'The requested change would violate a required relation between models.',
  P2015: 'A related record could not be found. Please ensure the related record exists.',
  P2016: "There's an error interpreting the query. Please review the query syntax and structure.",
  P2017: 'The records for a relation between models are not connected. Please connect the related records.',
  P2018: 'The required connected records were not found. Please ensure the necessary records exist.',
  P2019: "There's an error with the provided input data. Please review and correct the input.",
  P2020: 'The provided value is out of range for the specified data type. Please provide a valid value.',
  ...
  P2023: "There's inconsistency in the data of the specified column. Please review and correct the data.",
  P2024: 'Timed out fetching a new connection from the connection pool. Please retry later.',
  P2025:
    'An operation failed due to missing required dependent records. Please ensure all necessary records are present.',
  P2026: 'The query uses a feature not supported by the current database provider.',
  P2027:
    'Multiple errors occurred on the database during query execution. Please review the errors and fix the issues.',
  P2028: 'An error occurred with the transaction API. Please review and resolve the transaction-related issue.',
  P2030: 'Cannot find a fulltext index for the search. Add a fulltext index to your schema using @@fulltext.',
  P2031: 'Prisma requires MongoDB to be run as a replica set for transactions. Please set up MongoDB as a replica set.',
  P2033:
  ...
  P2034: 'Transaction failed due to a write conflict or a deadlock. Please retry the transaction.',
  P3000: 'Failed to create the database. There was an error during database creation.',
  P3001: 'Migration contains destructive changes and possible data loss. Please review the migration.',
  P3002: 'The attempted migration was rolled back due to an error. Please review the error details.',
  P3003:
  ...
  P3011: 'The migration cannot be rolled back as it was never applied to the database.',
  ...
  P3016: 'The fallback method for database resets failed. Migrate could not clean up the database entirely.',
  P3017: 'The migration could not be found. Please ensure the migration exists and you provided the full name.',
  P3018: 'A migration failed to apply. New migrations cannot be applied before the error is resolved.',
  P3019:
  ...
  P3021: 'Foreign keys cannot be created on this database. Please review how to handle this scenario.',
  P3022:
  ...
  P5002: 'The provided datasource is invalid. Please check the datasource URL and API key.',
  P5003: 'The requested resource does not exist.',
  P5004: 'The requested feature is not yet implemented. Please wait for future updates.',
  P5005: 'The schema needs to be uploaded. Please ensure the schema is uploaded before proceeding.',
  ...
  P5010: 'Cannot fetch data from the service. Please check your request and try again.',
  P5011:
  ...
  P5015: 'An error occurred with the interactive transaction. Please check the provided transaction ID and try again.',
};

export function getPrismaExceptionMessage(errorCode: string | undefined, fallbackMsg: string): string {

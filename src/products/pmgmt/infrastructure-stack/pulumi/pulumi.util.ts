...
export function buildResourceOptions(awsRegion: string) {
  return {
    transformations: [
...
export function generateSecurityGroup(
  inboundPorts: number[],
...
export function generateSecurityGroupForEC2(
  name: string,
  vpcId: pulumi.Input<string>
) {
...
export function generateSecurityGroupForRDS(
  name: string,
  vpcId: pulumi.Input<string>,

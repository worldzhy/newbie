...
export class RoleController {
  ...
  @Post('')
  @RequirePermission({resource: 'Role', action: PermissionAction.CREATE})
  @ApiBody({
  ...
  @Get('')
  @RequirePermission({resource: 'Role', action: PermissionAction.SELECT})
  @ApiParam({
    required: false,
    name: 'name',
  ...
  @Patch(':roleId')
  @RequirePermission({resource: 'Role', action: PermissionAction.UPDATE})
  @ApiParam({
    name: 'roleId',
    schema: {type: 'string'},
    description: 'The uuid of the role.',
  ...
  @Delete(':roleId')
  @RequirePermission({resource: 'Role', action: PermissionAction.DELETE})
  @ApiParam({
    name: 'roleId',
    schema: {type: 'string'},
